...
The working example is a 1 ha clip from the point cloud tile `10SGH1587` flown over the Carr Hirz Delta Fires burn site in Shasta County, California. The full catalog is distributed through the [USGS Staged Elevation FTP directory](#0); along with the data validation reports and metadata.
