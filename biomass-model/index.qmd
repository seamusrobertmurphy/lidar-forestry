...
# Load elevation raster (from DTM generation)
elev <- rast("elev_raster_100m.tif")
crs(elev) <- "epsg:3005"
...
elev <- aggregate(elev, fact = 100, fun = mean)
...
## 6. Bootstrapping for Distribution Matching
