...
# assigns larger memory to raster rendering
...
#TOC::before {
  ...
  height:200px;
  width: 200px;
  background-image: url('https://raw.githubusercontent.com/seamusrobertmurphy/lidar-forestry/refs/heads/main/assets/PNG/stem_detect_D.png');
...
# Save outputs
lidR::writeLAS(las_ha, "../data/las_1ha.laz")
terra::writeRaster(chm, "../data/chm_1ha.tif")
