...
#TOC::before {
  ...
  height:200px;
  width: 200px;
  background-image: url('https://raw.githubusercontent.com/seamusrobertmurphy/lidar-forestry/refs/heads/main/assets/PNG/las_tile_ahbau_norm.png');
...
::: {style="overflow: auto;"}
![Normalized point cloud](../assets/PNG/las_tile_ahbau_norm.png){style="float: left; margin-right: 2%;" width="49%"} ![Ground height distribution](../assets/PNG/las_tile_ahbau_norm_histogram.png){alt="DTM-2" style="float: left;" width="43.5%"}
:::
