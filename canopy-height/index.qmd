...
Extract dominant height directly from point clouds without rasterizing. This method is slower but preserves full point information. The `ttops` object is derived in [Chapter 2: Stem Detection](https://seamusrobertmurphy.quarto.pub/lidar-forestry/stem-detect/).
